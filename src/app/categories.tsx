...
export default function CategoriesScreen() {
  ...
  const loadCategories = async () => {
    try {
      ...
      console.error(error);
      Alert.alert('Greška', 'Ne mogu se učitati kategorije.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDeleteCategory = (id: string, name: string) => {
    Alert.alert(
      "Obriši kategoriju",
      `Jeste li sigurni da želite obrisati kategoriju "${name}"?\n(Ovo neće obrisati postojeće račune iz te kategorije, ali se ona više neće nuditi kod unosa.)`,
      [
    ...
    <View style={styles.container}>
      ...
      <View style={styles.addSection}>
        <TextInput
          ...
          placeholder="Npr. Vrtić, Kredit, Gorivo..."
